...
\begin{itemize}
  \item A screenshot or text file showing console output that includes the printed output.
...
Please write a three to ten sentence explanation for \textbf{ONE} of the two questions below. \bigskip
...
Use the code in \texttt{timeseries.R} or \texttt{timeseries.py} and the lecture slides to answer the following questions. You are required to do \textbf{TWO} of the three questions below. \bigskip
